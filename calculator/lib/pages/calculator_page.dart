...
class _CalculatorPageState extends State<CalculatorPage> {
  String _output = "0";
  String _currentOperator = "";  // Variável para armazenar a operação selecionada
...
void _buttonPressed(String buttonText) {
  setState(() {
    if (buttonText == "=") {
      try {
        // Avaliar a expressão com base no operador e nos valores armazenados
        _output = _evaluateExpression("$_previousValue$_currentOperator$_output");
      ...
      if (_previousValue.isNotEmpty) {
        ...
        _previousValue = _output;  // Armazena o valor atual antes de pressionar o operador
